...
const Footer = () => {
    ...
    return (
        <footer className='bg-sky-800 relative w-full'>
            <div className='max-w-screen-2xl m-auto'>
                <div className="sm:flex sm:items-center sm:justify-between p-6">
                    <span className="text-sm text-sky-500 sm:text-center dark:text-black">&copy; {year} <a href="https://www.google.com/" className="hover:underline">Primax Electronics</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://www.google.com/" className="text-black hover:text-sky-900 dark:hover:text-white">

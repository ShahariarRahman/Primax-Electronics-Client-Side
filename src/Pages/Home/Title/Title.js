...
const Title = () => {
    return (
        <div >
            <h1 className='text-3xl md:text-4xl lg:text-5xl text-gray-500 font-extrabold pt-10 py-6'>Welcome to <p className='text-sky-600'>Warehouse of Primax Electronics !</p></h1>

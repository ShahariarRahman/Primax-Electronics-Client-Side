...
const Title = () => {
    return (
        <div className=' w-full px-10 pb-12 rounded-2xl bg-black'>
            <h1 className='text-3xl md:text-4xl lg:text-5xl text-rose-700 font-extrabold pt-10 py-6'>Welcome to <p className='text-rose-100 mt-1'>Warehouse of Primax Electronics !</p></h1>
            <p className='text-xl text-rose-200 font-light py-3'>We are storing many kind of Electronics items.

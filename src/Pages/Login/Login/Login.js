                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit} >
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            ...
                            <input id="LoginEmail" ref={emailRef} name="email" type="email" required className="appearance-none rounded-none block w-full px-3 py-2 border border-sky-400 placeholder-sky-600 text-sky-700 rounded-t-md focus:outline-none sm:text-sm bg-sky-50" placeholder="Email address" defaultValue={'shahariar15-1670@diu.edu.bd'} />
                        </div>
                        <div>
